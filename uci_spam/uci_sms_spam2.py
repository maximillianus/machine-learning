...
# find most repeated words in spam
spam_list = df[df.textclass == 'spam']['textmessage'].tolist()
spam_list = ' '.join(spam_list)
spam_words = process_message(spam_list)
print(spam_words[:5])

fdist = nltk.FreqDist(spam_words)
print(fdist.most_common(10))


#### lines below are outdated and unused ####
